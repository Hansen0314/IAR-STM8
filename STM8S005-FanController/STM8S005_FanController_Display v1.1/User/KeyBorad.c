...
void KeyBorad_Hnadle(u8 KeyVaul)
{
   ...
   switch(KeyVaul)
   {
      ...
      else if (KeyHandle.Oper_Mode_Dis_State == 2)
      {
        ...
        {
          KeyHandle.Pm_State.On_alldate.yd.day --;
          if(KeyHandle.Pm_State.On_alldate.yd.day > 99)KeyHandle.Pm_State.On_alldate.yd.day = 0;
        }
        else if(KeyHandle.Pm_State.Pm_Num == 5)
        {
          KeyHandle.Pm_State.On_alldate.hms.hour --;
        ...
        {
          KeyHandle.Pm_State.Off_alldate.yd.day --;
          if(KeyHandle.Pm_State.Off_alldate.yd.day > 99)KeyHandle.Pm_State.Off_alldate.yd.day = 0;
        }
        else if(KeyHandle.Pm_State.Pm_Num == 8)
        {
          KeyHandle.Pm_State.Off_alldate.hms.hour --;
...
//      else if(KeyHandle.Wm_Num == 12)
      break;
      case S8_DOWN_VALUE:  
        if(KeyHandle.Wm_Num > 3) KeyHandle.Oper_Mode_State = 0;
      break;      
      default : 
      break;
  }
